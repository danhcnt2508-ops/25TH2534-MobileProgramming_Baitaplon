...
public class DataRepository {
    ...
    public static List<Question> getDummyQuestions() {
        ...
        questions.add(new Question(catID,
                "Ý nghĩa nào của công tác Bảo hộ lao động (BHLĐ) thể hiện tính nhân đạo sâu sắc?",
        ...
        questions.add(new Question(catID,
                "Theo Luật ATVSLĐ, 'Yếu tố nguy hiểm' được định nghĩa là gì?",
        ...
        questions.add(new Question(catID,
                "'Yếu tố có hại' trong sản xuất được hiểu là:",
        ...
        questions.add(new Question(catID,
                "Điều kiện vi khí hậu tại nơi làm việc bao gồm tập hợp các yếu tố nào sau đây?",
        ...
        questions.add(new Question(catID,
                "Khi nhiệt độ môi trường làm việc quá cao kết hợp với độ ẩm lớn hơn 80%, cơ thể người sẽ gặp hiện tượng gì?",
        ...
        questions.add(new Question(catID,
                "Tốc độ lưu thông không khí trong nhà xưởng vào mùa hè tiêu chuẩn nên được khống chế ở mức nào là tốt nhất?",
        ...
        questions.add(new Question(catID,
                "Tiếng ồn bắt đầu gây tổn thương cơ học cho màng nhĩ nếu cường độ vượt quá ngưỡng nào sau đây kéo dài?",
        ...
        questions.add(new Question(catID,
                "Loại bụi nào có khả năng đi sâu vào tận phế nang phổi và gây ra bệnh phổi nhiễm bụi nguy hiểm?",
        ...
        questions.add(new Question(catID,
                "Tác động của điện từ trường tần số cao đối với cơ thể người chủ yếu gây rối loạn hệ cơ quan nào trực tiếp nhất?",
        ...
        questions.add(new Question(catID,
                "Trong các biện pháp cải thiện vi khí hậu xưởng sản xuất, biện pháp nào mang tính chủ động và bền vững nhất?",
        ...
        questions.add(new Question(catID,
                "Tai nạn lao động xảy ra do 'thiết kế bệ máy không vững chắc gây rung động mạnh' thuộc nhóm nguyên nhân nào?",
        ...
        questions.add(new Question(catID,
                "Ý nghĩa kinh tế của công tác BHLĐ thể hiện rõ nhất qua việc:",
        ...
        questions.add(new Question(catID,
                "Yếu tố rung động cơ khí truyền vào cơ thể người thông qua dụng cụ cầm tay lâu ngày sẽ gây ra bệnh lý gì?",
        ...
        questions.add(new Question(catID,
                "Theo tiêu chuẩn vệ sinh lao động, độ ẩm không khí tối ưu tại khu vực sản xuất lắp ráp linh kiện điện tử là:",
        ...
        questions.add(new Question(catID,
                "Biện pháp kỹ thuật nào sau đây giúp kiểm soát hiệu quả nhất nồng độ khí độc phát sinh trong quá trình hàn điện?",
        ...
        questions.add(new Question(catID,
                "Bụi vô cơ phát sinh từ đá granite chứa thành phần hóa học nguy hiểm nào gây xơ hóa phế nang?",
        ...
        questions.add(new Question(catID,
                "Khi tiếp xúc với nguồn bức xạ hồng ngoại cường độ cao trong các lò luyện kim, cơ quan nào của con người dễ bị tổn thương nhất?",
        ...
        questions.add(new Question(catID,
                "Biện pháp cách ly nguồn phát sinh tiếng ồn bằng cabin cách âm thuộc nhóm biện pháp an toàn nào?",
        ...
        questions.add(new Question(catID,
                "Đối tượng chịu tác động trực tiếp và cần được bảo vệ chính của Luật ATVSLĐ là ai?",
        ...
        questions.add(new Question(catID,
                "Việc bố trí thời gian nghỉ ngơi hợp lý giữa các ca làm việc nặng nhọc là áp dụng biện pháp an toàn nào?",
        ...
        questions.add(new Question(catID,
                "Khói hàn điện thường chứa các hạt bụi oxit kim loại siêu mịn của kim loại nào sau đây có thể gây nhiễm độc mãn tính?",
        ...
        questions.add(new Question(catID,
                "Bệnh điếc nghề nghiệp có đặc điểm lâm sàng nguy hiểm nào sau đây?",
        ...
        questions.add(new Question(catID,
                "Khái niệm 'Vệ sinh lao động' tập trung nghiên cứu vấn đề gì?",
        ...
        questions.add(new Question(catID,
                "Bức xạ tử ngoại (UV) phát ra mạnh nhất từ nguồn nào sau đây trong xưởng cơ khí công nghiệp?",
        ...
        questions.add(new Question(catID,
                "Khi dòng điện xoay chiều tần số 50 Hz chạy qua cơ thể người, trị số dòng điện bắt đầu gây ra trạng thái giật tê nhẹ là bao nhiêu?",
        ...
        questions.add(new Question(catID,
                "Ý nghĩa chính trị của công tác BHLĐ thể hiện qua việc:","A. Thể hiện sự chăm lo của Đảng, Nhà nước đối với con người trong sự nghiệp công nghiệp hóa, hiện đại hóa.","B. Làm tăng giá trị xuất khẩu của hàng hóa.",
        ...
        questions.add(new Question(catID,
                "Chất lỏng cực độc PCB trước đây thường được sử dụng làm chất gì trong các thiết bị điện cũ?",
        ...
        questions.add(new Question(catID,
                "Nhóm nguyên nhân tai nạn lao động do 'người thợ mệt mỏi, ngủ gật trong ca trực' được phân loại vào:",
        ...
        questions.add(new Question(catID,
                "Nhận định nào sau đây đúng về mối quan hệ giữa An toàn lao động và Vệ sinh lao động?",
